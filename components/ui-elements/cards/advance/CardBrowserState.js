...
const CardBrowserState = () => {
  ...
  const statesArr = [
    {
      avatar: require('@/public/images/icons/google-chrome.png'),
      title: 'Google Chrome',
      value: '54.4%',
      chart: {
        type: 'radialBar',
    ...
    {
      avatar: require('@/public/images/icons/mozila-firefox.png'),
    ...
    {
      avatar: require('@/public/images/icons/apple-safari.png'),
      title: 'Apple Safari',
      value: '14.6%',
      chart: {
        type: 'radialBar',
    ...
    {
      avatar: require('@/public/images/icons/internet-explorer.png'),
    ...
    {
      avatar: require('@/public/images/icons/opera.png'),
      title: 'Opera Mini',
      value: '8.4%',
      chart: {
        type: 'radialBar',

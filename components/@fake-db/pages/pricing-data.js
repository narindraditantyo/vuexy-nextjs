...
const data = {
  pricing: {
    basicPlan: {
      title: 'Basic',
      img: require('@/public/images/illustration/Pot1.svg').default,
    ...
    standardPlan: {
      title: 'Standard',
      img: require('@/public/images/illustration/Pot2.svg').default,
    ...
    enterprisePlan: {
      title: 'Enterprise',
      img: require('@/public/images/illustration/Pot3.svg').default,

    ...
    data: [
      {
        ...
        by: 'Oliver Queen',
        size: '52kb',
        file: require('@/public/images/icons/jpg.png').default
      },
      {
        title: 'Parenting Guide',
        by: 'Alfred Pennyworth',
        size: '2.3mb',
        file: require('@/public/images/icons/doc.png').default
      },
      {
        title: 'Class Notes',
        by: 'Barry Allen',
      ...
      },
      {
        ...
        by: 'Walter White',
        size: '52mb',
        file: require('@/public/images/icons/xls.png').default
      }
    ]
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        img: require('@/public/images/portrait/small/avatar-s-3.jpg').default,
        date: '07/03/2020'
      },
      {
        title: 'Charlotte Gordon',
        email: 'CharlotteGordon@jourrapide.com',
        img: require('@/public/images/portrait/small/avatar-s-26.jpg').default,
        date: '14/03/2020'
      },
      {
        title: 'Robert Nash',
        email: 'RobertNash@dayrep.com',
        img: require('@/public/images/portrait/small/avatar-s-25.jpg').default,
        date: '21/03/2020'
      }
    ]
  }

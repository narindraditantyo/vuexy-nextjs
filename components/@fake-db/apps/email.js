  ...
  emails: [
    {
      ...
      from: {
        ...
        name: 'Tommy Sicilia',
        avatar: require('@/public/images/avatars/1.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'log.txt',
          thumbnail: require('@/public/images/icons/txt.png').default,
          url: '',
          size: '5mb'
        },
        {
          fileName: 'performance.xls',
          thumbnail: require('@/public/images/icons/xls.png').default,
          url: '',
          size: '10mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Tressa Gass',
        avatar: require('@/public/images/avatars/2.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('@/public/images/avatars/3.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Louetta Esses',
        avatar: require('@/public/images/avatars/4.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'report.doc',
          thumbnail: require('@/public/images/icons/doc.png').default,
          url: '',
          size: '32mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Bobbie Posvner',
        avatar: require('@/public/images/avatars/11.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Rebecca Gilder',
        avatar: require('@/public/images/avatars/6.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('@/public/images/avatars/9.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('@/public/images/avatars/7.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          ...
          thumbnail: require('@/public/images/icons/js.png').default,
          url: '',
          size: '29mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('@/public/images/avatars/10.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('@/public/images/avatars/8.png').default
      },
      to: [
        {
          name: 'me',

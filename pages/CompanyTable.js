...
const CompanyTable = () => {
  const data = [
      {
        img: require("@/public/images/icons/toolbox.svg"),
        name: "Dixons",
        email: "meguc@ruj.io",
      ...
      {
        img: require("@/public/images/icons/parachute.svg"),
        name: "Motels",
      ...
      {
        img: require("@/public/images/icons/brush.svg"),
        name: "Zipcar",
      ...
      {
        img: require("@/public/images/icons/star.svg"),
        name: "Owning",
        email: "us@cuhil.gov",
        icon: <Monitor size={18} />,
        category: "Technology",
      ...
      {
        img: require("@/public/images/icons/book.svg"),
        name: "Cafés",
      ...
      {
        img: require("@/public/images/icons/rocket.svg"),
        name: "Kmart",
      ...
      {
        img: require("@/public/images/icons/speaker.svg"),
        name: "Payers",
        email: "luk@izug.io",
        icon: <Watch size={18} />,
        category: "Fashion",
